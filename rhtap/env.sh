...
export IMAGE_URL=${IMAGE_URL-artifactory-docker-artifactory-jcr2.apps.rosa.rhtap-services.xmdt.p3.openshiftapps.com/rhtap/rhtap-qe-dotnet-basic:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-test-organization-jk/balau8v4f-dotnet-basic-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-tssc-tas.apps.cluster-zrw5r.zrw5r.sandbox1332.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-tssc-tas.apps.cluster-zrw5r.zrw5r.sandbox1332.opentlc.com}
...
export COSIGN_PUBLIC_KEY=LS0tLS1CRUdJTiBQVUJMSUMgS0VZLS0tLS0KTUZrd0V3WUhLb1pJemowQ0FRWUlLb1pJemowREFRY0RRZ0FFaklEZ3hGRnpIMHFUeURNdk5nNE5BdkFYZ2NBSApPbkZneThaV2NRSGJLZ3NLdXhZaEN3YTBCQUlnRUFVQ2N1dXI1Ymd5QWlROW1hN0poc3BDeG5aai9nPT0KLS0tLS1FTkQgUFVCTElDIEtFWS0tLS0tCg==
